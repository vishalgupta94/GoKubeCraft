...
export class BasicFargate extends Stack {
    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        const taskDefinition = this.getTaskDefinition(taskRole, taskExecutionRole)
    ...
    private getTaskDefinition(taskRole: Role, taskExecutionRole: Role) {
        const image = ContainerImage.fromAsset(join(process.cwd(), './docker-images/basic-fargate-stack/basic-express'), {
